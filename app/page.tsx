          ...
          <section className="px-6 py-8 bg-[#f6dbbf] relative overflow-hidden min-h-svh flex justify-center">
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl">
              ...
              <div className="md:w-1/2 text-center md:text-left">
                ...
                <Link href="" className="bg-white border border-gray-300 text-gray-800 font-semibold py-2 px-4 rounded shadow hover:bg-gray-100 transition duration-300">
                  Selengkapnya
                </Link>
              </div>
            </div>
          </section>
          <section className="p-20 min-h-svh flex flex-col items-center justify-center">
            <div className="flex flex-row max-w-5xl items-center">
              <div className="w-1/2">
                <h1 className="text-4xl mb-4 font-extrabold">TUJUAN MODUL</h1>
                <ul className="text-gray-700 text-lg md:text-xl">
              ...
              <Image src={Hero} alt="hero" className=" h-auto object-cover rounded-md" />
            </div>
          </section>
