              ...
              <div className="w-full md:w-1/2">                
                <ul className="text-gray-700 text-base md:text-xl">                
                  <li className="mb-2 flex items-start gap-x-2">
                    <svg className="w-6 h-6 flex-shrink-0 fill-green-500 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" /></svg>Meningkatkan Pemahaman Guru Tentang Pendidikan Seksual</li>
                  <li className="mb-2 flex items-start gap-x-2">
                    <svg className="w-6 h-6 flex-shrink-0 fill-green-500 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" /></svg>Menyediakan Informasi yang Akurat Tentang Pendidikan Seksual</li>
                  <li className="mb-2 flex items-start gap-x-2">
                    <svg className="w-6 h-6 flex-shrink-0 fill-green-500 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" /></svg>Meningkatkan Keterampilan Praktis Guru Tentang Pendidikan Seksual</li>
                  <li className="mb-2 flex items-start gap-x-2">
